...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci PACK_KEYS=0 COMMENT='Bloques disponibles' AUTO_INCREMENT=8 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Variables de configuracion' AUTO_INCREMENT=23 ;
...
CREATE TABLE IF NOT EXISTS `<nombre>registrado` (
